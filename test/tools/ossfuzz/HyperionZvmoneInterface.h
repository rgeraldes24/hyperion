...
struct CompilerInput
{
	CompilerInput(
		...
		std::map<std::string, hyperion::util::h192> _libraryAddresses,
	...
	std::map<std::string, hyperion::util::h192> libraryAddresses;
...
public:
	...
	void libraryAddresses(std::map<std::string, hyperion::util::h192> _libraryAddresses)
	{
