	...
	m_zvmVersion(_zvmVersion)
{
	...
	tx_context.block_coinbase = "Z787878787878787878787878787878787878787878787878"_address;
	tx_context.tx_gas_price = zvmc::uint256be{3000000000};
	tx_context.tx_origin = "Z929292929292929292929292929292929292929292929292"_address;
...
zvmc::Result ZVMHost::call(zvmc_message const& _message) noexcept
{
	...
	if (_message.recipient == "Z000000000000000000000000000000000000000000000001"_address)
		return precompileDepositRoot(_message);
	else if (_message.recipient == "Z000000000000000000000000000000000000000000000002"_address)
		return precompileSha256(_message);
	else if (_message.recipient == "Z000000000000000000000000000000000000000000000004"_address)
		return precompileIdentity(_message);
	else if (_message.recipient == "Z000000000000000000000000000000000000000000000005"_address)
		return precompileModExp(_message);
	else if (_message.recipient == "Z000000000000000000000000000000000000000000000006"_address)
		return precompileALTBN128G1Add(_message);
	else if (_message.recipient == "Z000000000000000000000000000000000000000000000007"_address)
		return precompileALTBN128G1Mul(_message);
	else if (_message.recipient == "Z000000000000000000000000000000000000000000000008"_address)
