...
concept ShuffleOperationConcept = requires(ShuffleOperations ops, size_t sourceOffset, size_t targetOffset, size_t depth) {
	...
	// In terms of QRVM opcodes this is supposed to be a `SWAP<depth>`.
	...
	// In terms of QRVM opcodes this is `POP`.
...
/// the slot `depth` slots below the top. In terms of QRVM opcodes this is supposed to be a `SWAP<depth>`.
