...
from isolate_tests import extract_hyperion_docs_cases, extract_yul_docs_cases
...
class TestExtractDocsCases(unittest.TestCase):
    ...
    def test_hyperion_block_with_directives(self):
        ...
        self.assertEqual(extract_hyperion_docs_cases(CODE_BLOCK_WITH_DIRECTIVES_RST_PATH), expected_cases)
