...
class TestFileReport(PrepareReportTestBase):
    ...
    def test_format_report_should_print_error_if_contract_report_list_is_missing(self):
        report = FileReport(file_name=Path('file.hyp'), contract_reports=None)

        expected_output = "file.hyp: <ERROR>\n"

        self.assertEqual(report.format_report(), expected_output)

    def test_format_report_should_not_print_anything_if_contract_report_list_is_empty(self):
        report = FileReport(file_name=Path('file.hyp'), contract_reports=[])
...
class TestPrepareReport_Statistics(unittest.TestCase):
    ...
    def test_aggregate_bytecode_and_metadata_present(self):
        ...
        statistics.aggregate(FileReport(file_name=Path('F'), contract_reports=[ContractReport('C', 'c.hyp', 'B', 'M')]))
        self.assertEqual(statistics, Statistics(1, 1, 0, 0, 0))

    def test_aggregate_bytecode_missing(self):
        statistics = Statistics()
        statistics.aggregate(FileReport(file_name=Path('F'), contract_reports=[ContractReport('C', 'c.hyp', None, 'M')]))
        self.assertEqual(statistics, Statistics(1, 1, 0, 1, 0))

    def test_aggregate_metadata_missing(self):
        statistics = Statistics()
        statistics.aggregate(FileReport(file_name=Path('F'), contract_reports=[ContractReport('C', 'c.hyp', 'B', None)]))
    ...
    def test_aggregate_multiple_contract_reports(self):
        statistics = Statistics()
        statistics.aggregate(FileReport(file_name=Path('F'), contract_reports=[
            ContractReport('C', 'c.hyp', 'B', 'M'),
            ContractReport('C', 'c.hyp', None, 'M'),
            ContractReport('C', 'c.hyp', 'B', None),
            ContractReport('C', 'c.hyp', None, None),
        ]))
...
class TestParseStandardJSONOutput(PrepareReportTestBase):
        ...
        expected_report = FileReport(
            ...
            contract_reports=[
                ...
                ContractReport(
                    ...
                    metadata='{"compiler":{"version":"0.8.0+commit.c7dfd78e"},"language":"Hyperion","output":{"abi":[],"devdoc":{"kind":"dev","methods":{},"version":1},"userdoc":{"kind":"user","methods":{},"version":1}},"settings":{"compilationTarget":{"syntaxTests/scoping/library_inherited2.hyp":"A"},"qrvmVersion":"shanghai","libraries":{},"metadata":{"bytecodeHash":"ipfs"},"optimizer":{"enabled":false,"runs":200},"remappings":[]},"sources":{"syntaxTests/scoping/library_inherited2.hyp":{"keccak256":"0xd0619f00638fdfea187368965615dbd599fead93dd14b6558725e85ec7011d96","urls":["bzz-raw://ec7af066be66a223f0d25ba3bf9ba6dc103e1a57531a66a38a5ca2b6ce172f55","dweb:/ipfs/QmW1NrqQNhnY1Tkgr3Z9oM8buCGLUJCJVCDTVejJTT5Vet"]}},"version":1}',
                ),
                ContractReport(
                    contract_name='B',
                    file_name=Path('syntaxTests/scoping/library_inherited2.hyp'),
                    ...
                    metadata='{"compiler":{"version":"0.8.0+commit.c7dfd78e"},"language":"Hyperion","output":{"abi":[{"inputs":[{"internalType":"uint256","name":"value","type":"uint256"}],"name":"bar","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"pure","type":"function"}],"devdoc":{"kind":"dev","methods":{},"version":1},"userdoc":{"kind":"user","methods":{},"version":1}},"settings":{"compilationTarget":{"syntaxTests/scoping/library_inherited2.hyp":"B"},"qrvmVersion":"shanghai","libraries":{},"metadata":{"bytecodeHash":"ipfs"},"optimizer":{"enabled":false,"runs":200},"remappings":[]},"sources":{"syntaxTests/scoping/library_inherited2.hyp":{"keccak256":"0xd0619f00638fdfea187368965615dbd599fead93dd14b6558725e85ec7011d96","urls":["bzz-raw://ec7af066be66a223f0d25ba3bf9ba6dc103e1a57531a66a38a5ca2b6ce172f55","dweb:/ipfs/QmW1NrqQNhnY1Tkgr3Z9oM8buCGLUJCJVCDTVejJTT5Vet"]}},"version":1}',
                ),
                ContractReport(
                    contract_name='Lib',
                    file_name=Path('syntaxTests/scoping/library_inherited2.hyp'),
                    ...
                    metadata='{"compiler":{"version":"0.8.0+commit.c7dfd78e"},"language":"Hyperion","output":{"abi":[],"devdoc":{"kind":"dev","methods":{},"version":1},"userdoc":{"kind":"user","methods":{},"version":1}},"settings":{"compilationTarget":{"syntaxTests/scoping/library_inherited2.hyp":"Lib"},"qrvmVersion":"shanghai","libraries":{},"metadata":{"bytecodeHash":"ipfs"},"optimizer":{"enabled":false,"runs":200},"remappings":[]},"sources":{"syntaxTests/scoping/library_inherited2.hyp":{"keccak256":"0xd0619f00638fdfea187368965615dbd599fead93dd14b6558725e85ec7011d96","urls":["bzz-raw://ec7af066be66a223f0d25ba3bf9ba6dc103e1a57531a66a38a5ca2b6ce172f55","dweb:/ipfs/QmW1NrqQNhnY1Tkgr3Z9oM8buCGLUJCJVCDTVejJTT5Vet"]}},"version":1}',
                ),
    ...
    def test_parse_standard_json_output_should_report_error_on_empty_json(self):
        expected_report = FileReport(file_name=Path('file.hyp'), contract_reports=None)

        self.assertEqual(parse_standard_json_output(Path('file.hyp'), '{}'), expected_report)

    def test_parse_standard_json_output_should_report_error_if_contracts_is_empty(self):
        compiler_output = '{"contracts": {}}'

        expected_report = FileReport(file_name=Path('contract.hyp'), contract_reports=None)

        self.assertEqual(parse_standard_json_output(Path('contract.hyp'), compiler_output), expected_report)
    ...
    def test_parse_standard_json_output_should_not_report_error_if_there_is_at_least_one_file_with_contracts(self):
        ...
        expected_report = FileReport(
            ...
            contract_reports=[ContractReport(contract_name='A', file_name=Path('contract1.hyp'), bytecode=None, metadata=None)]
        )
    ...
    def test_parse_standard_json_output_should_report_error_on_unimplemented_feature_error(self):
        ...
        self.assertEqual(parse_standard_json_output(Path('file.hyp'), UNIMPLEMENTED_FEATURE_JSON_OUTPUT), expected_report)

    def test_parse_standard_json_output_should_report_error_on_stack_too_deep_error(self):
        expected_report = FileReport(file_name=Path('file.hyp'), contract_reports=None)

        self.assertEqual(parse_standard_json_output(Path('file.hyp'), STACK_TOO_DEEP_JSON_OUTPUT), expected_report)

    def test_parse_standard_json_output_should_report_error_on_code_generation_error(self):
        expected_report = FileReport(file_name=Path('file.hyp'), contract_reports=None)

        self.assertEqual(parse_standard_json_output(Path('file.hyp'), CODE_GENERATION_ERROR_JSON_OUTPUT), expected_report)
...
class TestParseCLIOutput(PrepareReportTestBase):
    def test_parse_standard_json_output_should_report_missing_if_value_is_just_whitespace(self):
        ...
        expected_report = FileReport(
            file_name=Path('contract.hyp'),
            contract_reports=[
                ContractReport(contract_name='A', file_name=Path('contract.hyp'), bytecode=None, metadata=None),
                ContractReport(contract_name='B', file_name=Path('contract.hyp'), bytecode=None, metadata=None),
            ]
        )
    ...
    def test_parse_cli_output_should_report_error_on_empty_output(self):
        ...
        self.assertEqual(parse_cli_output(Path('file.hyp'), ''), expected_report)

    def test_parse_cli_output_should_report_missing_bytecode_and_metadata(self):
        compiler_output = dedent("""\
            ======= syntaxTests/scoping/library_inherited2.hyp:A =======
        ...
        self.assertEqual(parse_cli_output(Path('syntaxTests/scoping/library_inherited2.hyp'), compiler_output), expected_report)

    def test_parse_cli_output_should_report_error_on_unimplemented_feature_error(self):
        expected_report = FileReport(file_name=Path('file.hyp'), contract_reports=None)

        self.assertEqual(parse_cli_output(Path('file.hyp'), UNIMPLEMENTED_FEATURE_CLI_OUTPUT), expected_report)

    def test_parse_cli_output_should_report_error_on_stack_too_deep_error(self):
        expected_report = FileReport(file_name=Path('file.hyp'), contract_reports=None)

        self.assertEqual(parse_cli_output(Path('file.hyp'), STACK_TOO_DEEP_CLI_OUTPUT), expected_report)
    ...
    def test_parse_cli_output_should_handle_leading_and_trailing_spaces(self):
        ...
        expected_report = FileReport(
            file_name=Path('contract.hyp'),
            contract_reports=[
                ContractReport(contract_name='C', file_name=Path('contract.hyp'), bytecode='60806040523480156', metadata='{  }')
            ]
        )

        self.assertEqual(parse_cli_output(Path('contract.hyp'), compiler_output), expected_report)
    ...
    def test_parse_cli_output_should_handle_empty_bytecode_and_metadata_lines(self):
        ...
        expected_report = FileReport(
            file_name=Path('contract.hyp'),
            contract_reports=[
                ContractReport(contract_name='C', file_name=Path('contract.hyp'), bytecode='60806040523480156', metadata=None),
                ContractReport(contract_name='D', file_name=Path('contract.hyp'), bytecode=None, metadata='{}'),
                ContractReport(contract_name='E', file_name=Path('contract.hyp'), bytecode=None, metadata=None),
            ]
        )
    ...
    def test_parse_cli_output_should_handle_link_references_in_bytecode(self):
        ...
        expected_report = FileReport(
            file_name=Path('contract.hyp'),
            contract_reports=[
                ContractReport(contract_name='C', file_name=Path('contract.hyp'), bytecode='73123456789012345678901234567890123456789073__$fb58009a6b1ecea3b9d99bedd645df4ec3$__5050', metadata=None),
                ContractReport(contract_name='D', file_name=Path('contract.hyp'), bytecode='__$fb58009a6b1ecea3b9d99bedd645df4ec3$__', metadata=None),
            ]
        )
        # pragma pylint: enable=line-too-long
