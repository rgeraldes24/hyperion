...
struct InterpreterState
{
	...
	util::h192 address = util::h192("0x000000000000000000000000000000000000000011111111");
	u256 balance = 0x22222222;
	u256 selfbalance = 0x22223333;
	util::h192 origin = util::h192("0x000000000000000000000000000000000000000033333333");
	util::h192 caller = util::h192("0x000000000000000000000000000000000000000044444444");
	u256 callvalue = 0x55555555;
	/// Deployed code
	bytes code = util::asBytes("codecodecodecodecode");
	u256 gasprice = 0x66666666;
	util::h192 coinbase = util::h192("0x000000000000000000000000000000000000000077777777");
