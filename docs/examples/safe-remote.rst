...
an item from the seller and the seller would like to get some compensation, e.g. ZND,
...
contract as escrow. As soon as this happened, the ZND will stay locked inside
...
.. code-block:: hyperion
    ...
    contract Purchase {
        ...
        /// Abort the purchase and reclaim the znd.
        ...
        /// Transaction has to include `2 * value` znd.
        /// The znd will be locked until confirmReceived
        /// is called.
        ...
        /// This will release the locked znd.
