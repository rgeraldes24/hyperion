...
private:
	...
	/// Parses the optional znd value that can be passed alongside the
	/// function call arguments. Throws an InvalidZNDValueEncoding exception
