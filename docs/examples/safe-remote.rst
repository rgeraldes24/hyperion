...
an item from the seller and the seller would like to get some compensation, e.g. Zond,
...
contract as escrow. As soon as this happened, the Zond will stay locked inside
...
.. code-block:: hyperion
    ...
    contract Purchase {
        ...
        /// Abort the purchase and reclaim the zond.
