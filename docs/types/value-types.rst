...
.. warning::
    ...
    // TODO(rgeraldes24)
    You can use ``address(uint192(bytes24(b)))``, which results in ``Z111122223333444455556666777788889999aAaa``,
    or you can use ``address(uint192(uint256(b)))``, which results in ``Z777788889999AaAAbBbbCcccddDdeeeEfFFfCcCc``.
